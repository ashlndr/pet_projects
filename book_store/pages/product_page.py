...
class ProductPage(MainPage):
    ...
    def check_added_to_basket_product_name(self):
        product_name_from_alert = (self.wait_for_element(*ProductPageLocators.ADDED_PRODUCT_NAME_IN_ALERT)).text
        product_name_from_page = (self.wait_for_element(*ProductPageLocators.PRODUCT_NAME_ON_PAGE)).text
    ...
    def check_total_price_in_basket(self):
        total_basket_price = (self.wait_for_element(*ProductPageLocators.PRODUCTS_IN_BASKET_PRICE)).text
        product_price_from_page = (self.wait_for_element(*ProductPageLocators.PRODUCT_PRICE_ON_PAGE)).text
